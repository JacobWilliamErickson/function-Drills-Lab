...
function faveColorFinder(favColor){
  if(favColor.includes('red')){
    console.log("red is a great color")
  } else if (favColor.includes(`green`)){
    console.log("green is a solid favorite color")
  } else if (favColor.includes(`black`)){
...
function emailCheck(email) {
  ...
  if(email.includes('@')){
    ...
    console.log('must provide a valid email')
  }
}
// emailCheck("jake@")
...
//CODE HERE
function buyWithGold(gold){
  let frogs = (gold/3)
  return frogs
}
totalFrogs= buyWithGold(100)
...
////////////////// PROBLEM 21 ////////////////////
let sampleArray = [0,1,2,3,4,7,8,9,11,15]
/*
...
function ArrChecker(numbersarr){
...
let bathtubScope = ['squeaky','duck','nautical']
